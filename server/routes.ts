...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/debug/test-email", async (req, res) => {
    try {
      ...
      const subject = req.body.subject || "TrustLoopz Test Email";
      const message = req.body.message || "This is a test email from TrustLoopz to verify email delivery is working correctly.";
      ...
      const success = await sendEmail({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 600px;">
            <h2 style="color: #4a6ee0;">TrustLoopz Test Email</h2>
            <p>${message}</p>
